...
| --------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------- | -------------------------------------------------------------------- |
| `{ALL TYPES}`   | **[ABS](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L405)**                      | `{ALL TYPES}` NUMBER                                | CONVERTS `NUMBER` TO POSITIVE IF NEGATIVE                            |
...
| `DOUBLE`        | **[FABS](https://github.com/TeomanDeniz/C_MT/blob/main/MATH/FABS.c)**                        | `DOUBLE` NUMBER                                     | CONVERTS `NUMBER` TO POSITIVE IF NEGATIVE (FLOAT)                    |
|                 | **[FREE](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L406)**                     | `VOID *` INPUT                                      | RESET, REMOVE OR DELETE POINTER                                      |
...
| `INT`           | **[IS_ARRAY](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L429)**                 | `{ALL TYPES}` VARIABLE                              | CHECK IF `VARIABLE` ARRAY (RETURNS 1 AS TRUE)                        |
| `INT`           | **[IS_POINTER](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L430)**               | `{ALL TYPES}` VARIABLE                              | CHECK IF `VARIABLE` POINTER (RETURNS 1 AS TRUE)                      |
...
| `VOID *`        | **[MALLOC](https://github.com/TeomanDeniz/C_MT/blob/main/MEMORY/MALLOC.c#L2585)**            | `UNSIGNED INT` SIZE                                 | LOCATES MEMORY IN ORDERED `SIZE`                                     |
| `{ALL TYPES}`   | **[MAX](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L416)**                      | `{ALL TYPES}` A, `{ALL TYPES}` B                    | RETURNS BIGGES VALUE BETWEEN `A` AND `B`                             |
...
| `{ALL TYPES}`   | **[MIN](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L422)**                      | `{ALL TYPES}` A, `{ALL TYPES}` B                    | RETURNS SMALLEST VALUE BETWEEN `A` AND `B`                           |
| `DOUBLE`        | **[POW](https://github.com/TeomanDeniz/C_MT/blob/main/MATH/POW.c)**                          | `DOUBLE` NUMBER, `SIGNED INT` POWER                 | CALCULATING GIVEN EXPONENTIAL NUMBER AS `DOUBLE`                     |
...
| `INT`           | **[PRINTF](https://github.com/TeomanDeniz/C_MT/blob/main/MODULES/PRINTF.c#L763)**            | `CHAR` __, `...`                                    | SAME WITH PRINTF, CAN USE BOTH UPPERCASE AND LOWERCASE COMMANDS      |
| `INT`           | **[PRINTF_FD](https://github.com/TeomanDeniz/C_MT/blob/main/MODULES/PRINTF.c#L796)**         | `INT` FD, `CHAR` __, `...`                          | SAME WITH PRINTF, PRINT THE PRINTF STRING TO ORDERED FILE            |
...
| `CHAR`          | **[SIZEOF](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L411)**                   | `{ALL TYPES}` VARIABLE                              | THE REMAKE OF ORIGINAL `SIZEOF` (WORKS SAME)                         |
...
| `INT`           | **[TYPECMP](https://github.com/TeomanDeniz/C_MT/blob/main/%23C_MT.h#L428)**                  | `{ALL TYPES}`, `{ALL TYPES}`                        | COMPARE VARIABLES' TYPES OR JUST TYPES (RETURNS 1 AS TRUE)           |
