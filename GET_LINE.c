...
STATIC INLINE CHAR
	*GL_STRCHR(CHAR *STRING, INT CHARACTER)
{
...
STATIC INLINE CHAR
	*GL_STRJOIN(CHAR *STRING_NEWLINE, CHAR *BUFFER)
{
	REGISTER VOLATILE SIZE_T	C1;
	REGISTER VOLATILE SIZE_T	C2;
	CHAR						*STRING;
...
{
	REGISTER VOLATILE SIGNED INT	C1;
	REGISTER VOLATILE SIGNED INT	C2;
	CHAR							*STRING;
