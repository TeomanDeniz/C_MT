...
STATIC INT	COUNT_WORDS(CHAR CONST *STR, CHAR CHARACTER)
{
	INT (COUNTER) = 0;
	INT (RESULT) = 0;
	WHILE (STR[COUNTER])
...
STATIC CHAR	*MAKE_WORDS(CHAR *WORD, CHAR CONST *STR, INT COUNT_2, INT LINE)
{
	INT (COUNTER) = 0;
	WHILE (LINE > 0)
...
STATIC CHAR	**SPLIT_WORDS(CHAR **RESULT, CHAR CONST *STR, CHAR CHARACTER, INT COUNTER)
{
	INT (COUNT_1) = 0;
	INT (COUNT_2) = 0;
	INT (LINE) = 0;
